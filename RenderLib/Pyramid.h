...
class PyramidGeometry : public GeometryHelper
{
	...
	void CreateGeometry(float xSize, float ySize, float zSize)
	{
		...
		//Finish Pyramid Geometry.
		//Change all of the normals with a height of 1 to have no x or z values
		...
		glm::vec3 faceNormals[] =
		{
			...
			glm::vec3(0,0,0), glm::vec3(0,1,0), glm::vec3(0,-1,0)
		};
...
public:
	PyramidGeometry(float xSize, float ySize, float zSize) { CreateGeometry(xSize, ySize, zSize); }
